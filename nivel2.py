...
def main():
    ...
    dir_fondo = "fondos/fondoNiveles/fondoNivel2.png"
    ...
    pygame.mixer.music.load("sonidos/songNivel2.mp3")  # Cargar soundtrack del menú
                ...
                if nave.salud > 0:  #si el tiempo del nivel se acabo y el jugador todavia tiene vida
                    ...
                    if 209 <= x <= 486 and 389 <= y<= 408:
                        if not select_sound:
                            select.play()
                            select_sound = True
                        pygame.draw.rect(screen, (238, 37, 201), (496, 395, 25, 7))  
                    elif 199 <= x <= 502 and 445 <= y <= 464:
                        if not select_sound:
                            select.play()
                            select_sound = True
